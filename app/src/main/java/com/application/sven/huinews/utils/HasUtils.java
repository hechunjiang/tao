...
public class HasUtils {
    ...
    public String sign(String time, String nonce_str, String json, String ticket) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        final SecretKeySpec secret_key = new SecretKeySpec(asciiCs.encode(Constant.SIGN_KEY).array(), "HmacSHA256");
        sha256_HMAC.init(secret_key);
        String sha1 = "";
        try {
            sha1 = SHA1(mStr);
            LogUtil.showLog("msg--sha1:" + SHA1(mStr) + "====time:" + time + "====nonce_str:" + nonce_str + "====json:" + mJson + "====mStr:" + mStr);
        ...
        LogUtil.showLog("msg---<sign:>:" + result + ":<time:>" + time + ":<nonce_str:>" + nonce_str);
        return result;
    }
