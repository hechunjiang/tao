package com.application.sven.huinews.view.read.widght;
...
import com.application.sven.huinews.view.read.ReadView;
...
public class PageWidget extends ReadView {
    ...
    public synchronized void setTheme(int theme) {
        ...
        int bgColor = ThemeManager.setReaderBgColor(theme);
