 ...
 * effect:
 */
public class GridBookItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridBookItemDecoration(Context context, int spanCount, int dividerWidthDp) {
        this.spanCount = spanCount;
        this.dividerWidth = CommonUtils.dip2px(context, dividerWidthDp);
