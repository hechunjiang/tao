 ...
 * effect:
 */
public class HeadAndFooterRecyclerView  extends RecyclerView {
    ...
    public HeadAndFooterRecyclerView(Context context) {
        super(context);
    }

    public HeadAndFooterRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HeadAndFooterRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
