 ...
 * effect:
 */
public class VideoDetailsRecommedAdapter extends RecyclerView.Adapter {
    ...
    public VideoDetailsRecommedAdapter(Context mContext) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (type == TYPE_DATA) {
            final VideoDetailsResponse.VideoInfo.RecommenBean data = (VideoDetailsResponse.VideoInfo.RecommenBean) mDats.get(position);
            FrescoUtil.loadDefImg(vh.iv_thumb, data.getVideo_cover());
            vh.tv_content.setText(data.getTitle());
            vh.tv_name.setText(data.getUser_nickname());
