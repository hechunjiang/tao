...
import com.application.sven.huinews.utils.AnimationUtils;
...
import com.application.sven.huinews.view.dialog.RedGoldDialog;
 ...
 * effect: 横向视频
 */
public class HorizontalVideoActivity extends BaseActivity<VideoPresenter, VideoModel> implements VideoContract.View {
    ...
    public static void toThis(Context mContext, VideoInfoRequest request) {
        Intent intent = new Intent(mContext, HorizontalVideoActivity.class);
    ...
    public int getLayoutId() {
        ...
        MobclickAgent.onEvent(mContext, UMengUtils.HORIZONTAL_VIDEO);
        MobclickAgent.onEvent(mContext, UMengUtils.HORIZONTAL_VIDEO, UMengUtils.HORIZONTAL_VIDEO);
    ...
    public void initEvents() {
        ...
        mAdapter.setOnShareClickLisenter(new VideoHorizontalAdapter.onItemFuncationClickLisenter() {
            ...
            public void onComment(VideoListResponse.VideoList.ListBean mData, TextView tv_msg) {
                HorizontalVideoActivity.this.tvMsg = tv_msg;
                mCommentPage = 1;
    ...
    @Override
    public void setGoldView(final VideoListResponse.VideoList.ListBean mData, VideoTaskResponse.Data data, int type) {
        //将视频加入数据库
